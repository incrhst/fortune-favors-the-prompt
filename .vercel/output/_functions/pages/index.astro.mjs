import { e as createComponent, k as renderHead, r as renderTemplate, g as addAttribute, l as renderScript } from '../chunks/astro/server_d30vpj_X.mjs';
import 'piccolore';
import 'clsx';
/* empty css                                 */
import { getApprovedPrompts } from '../chunks/db_Bscd1bOd.mjs';
...
by ${prompt.guest_name} </span> </div> </a>`)} </div> </div> ${renderScript($$result, "/Users/davidbain/difiledem/Downloads/code/prompt/src/pages/index.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
